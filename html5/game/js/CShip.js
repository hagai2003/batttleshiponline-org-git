function CShip(iX, iY, oType, oParentContainer, oAttachBoard){
    ...
    this._init = function(iX, iY, oType, oParentContainer, oAttachBoard){
        ...
        _oShip.y = iY;
        if(_bSandBoxMode){
            _oListenerMouseDown = _oShip.on("mousedown", this._onShipClick);
            _oListenerMouseMove = _oShip.on("pressmove", this._onShipMove);
            _oListenerDoubleClick = _oShip.on("dblclick", this._onShipRotate);
            _oListenerMouseUp = _oShip.on("pressup", this._onShipRelease);
    ...
    this.unload = function(){
        if(_bSandBoxMode){
            _oShip.off("mousedown", _oListenerMouseDown);
            _oShip.off("pressmove", _oListenerMouseMove);
            _oShip.off("dblclick", _oListenerDoubleClick);
            _oShip.off("pressup", _oListenerMouseUp);
