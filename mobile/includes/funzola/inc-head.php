...
function votegame(rating)
{
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{
			document.getElementById("votethumbdown").innerHTML="";
			document.getElementById("votethumbup").innerHTML="";
			document.getElementById("votethumbdown").className="gamevotedowndisabled";
			document.getElementById("votethumbup").className="gamevoteupdisabled";
			
			document.getElementById("votestats").innerHTML=xmlhttp.responseText;
		}
	}
	xmlhttp.open("GET","<?php echo returnbaseurl();?>includes/updatevote.php?gameid=<?php echo get_current_page_content("gameid");?>&vote="+rating+'&' + Math.random(),true);
	xmlhttp.send();
}
</script>
