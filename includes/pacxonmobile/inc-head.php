...
<link rel="stylesheet" type="text/css" href="/generalmobile.css"/>
<?php } else { ?>
<link rel="stylesheet" type="text/css" href="/<?php echo $GLOBALS['general_css'];?>"/>
<?php } ?>
<?php if ($GLOBALS['include_theme_css']) {?>
<link rel="stylesheet" type="text/css" href="<?php echo $GLOBALS['theme'];?>.css"/>
<?php } ?>
<?php
...
<script src="/includes/jquery.swfobject.1-1-1.min.js"></script>